...
\begin{document}
    ...
    \include{Chapters/Building.tex}
    \include{Schematic/block.tex}
    \include{Chapters/Testing.tex}
    \include{Chapters/Issue.tex}
    \include{Chapters/Controll.tex}
    \include{Chapters/Map.tex}
\newpage
